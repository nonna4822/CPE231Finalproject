        ...
        <div class="container-fluid" style="margin-top:390px;text-align:center;">
            <div class="row">
                <div class="col" style="display:inline-flex;">
                    ...
                    <?php
      if(isset($_SESSION['firstname']) && $_SESSION['choice'] =='student'){
        ...
        <div class=\"form-group\">
            <div class=\"dropdown\">
                <a href=\"#\" class=\"button1\" style=\"width:70%\">
                    ...
                    <button onclick =\"location.href='studentview.php'\"onmouseover=\"myFunction()\" class=\"dropbtn\">".$_SESSION['firstname']." ".$_SESSION['lastname']."</button>
